    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between shrink-0">
          <h2 className="text-lg font-semibold text-gray-900">Value Stream Details</h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-4 overflow-y-auto flex-1 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 resize-none"
          ...
          {/* Applications */}
          <div>
            <label htmlFor="stream-applications" className="block text-sm font-medium text-gray-700 mb-1">
              Involved Applications
              <span className="text-xs text-gray-400 ml-1">(one per line)</span>
            </label>
            <textarea
          ...
          {/* Involved Teams */}
          <div>
            <label htmlFor="stream-teams" className="block text-sm font-medium text-gray-700 mb-1">
              Involved Teams
              <span className="text-xs text-gray-400 ml-1">(one per line)</span>
            </label>
            <textarea
          ...
          {/* Known Issues */}
          <div>
            <label htmlFor="stream-issues" className="block text-sm font-medium text-gray-700 mb-1">
              Known Issues
              <span className="text-xs text-gray-400 ml-1">(one per line)</span>
            </label>
            <textarea
          ...
          {/* Created Values */}
          <div>
            <label htmlFor="stream-values" className="block text-sm font-medium text-gray-700 mb-1">
              Created Values
              <span className="text-xs text-gray-400 ml-1">(one per line)</span>
            </label>
            <textarea
          ...
          {/* Customer Segments */}
          <div>
            <label htmlFor="stream-segments" className="block text-sm font-medium text-gray-700 mb-1">
              Customer Segments
              <span className="text-xs text-gray-400 ml-1">(one per line)</span>
            </label>
            <textarea
