  ...
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-gray-900">
      ...
      <header className="flex items-center justify-between h-14 px-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shrink-0">
        ...
        <div className="flex items-center gap-1 lg:gap-2 text-sm text-gray-500 dark:text-gray-400 min-w-0 flex-shrink overflow-hidden">
          <Button onClick={() => setShowStreamMeta(true)} size="sm" variant="ghost" aria-label="Edit stream details">
            <svg className="w-4 h-4 lg:mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="hidden lg:inline">Stream Details</span>
          </Button>
          <Button
            ...
            className={cn(showStats && 'bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300')}
          >
            <svg className="w-4 h-4 lg:mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-px h-5 bg-gray-200 dark:bg-gray-600 mx-1 hidden lg:block" />
