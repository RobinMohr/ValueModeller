...
export function NodeSearchPanel() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="absolute top-3 right-24 z-10 flex items-center gap-1.5 rounded-md bg-white dark:bg-gray-800 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-400 shadow-md border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
  ...
  return (
    <div className="absolute top-3 right-24 z-10 w-72 rounded-lg bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      {/* Search input */}
